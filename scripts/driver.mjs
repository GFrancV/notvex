...
const COMMANDS = {
  ...
  async errors() {
    ...
    console.log('listening for errors (see above)')
  },
...
rl.on('close', async () => { await COMMANDS.quit().catch(() => {}); process.exit(0) })

console.log('Notvex driver — "help" for commands, "launch" to start')
rl.prompt()
