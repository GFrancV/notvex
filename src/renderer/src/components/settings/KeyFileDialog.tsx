...
interface KeyFileDialogProps {
  open: boolean
  onClose: () => void
  hasKeyFile: boolean
  onHasKeyFileChange: (hasKeyFile: boolean) => void
}
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            {keyFileStep === 'post-activate-mnemonic' || keyFileStep === 'post-remove-mnemonic'
          ...
          {keyFileStep === 'idle' && (
            <>
              <p className="text-muted-foreground text-xs">
                A key file adds a second factor to unlock your vault. You need both your password
                and the key file to access your notes. If you lose the key file, access is
                permanently lost.
              </p>
            ...
            <div className="space-y-3">
              <Alert className="border-warning/30 bg-warning/10 border">
                ...
                <AlertDescription className="text-warning text-xs">
                  ...
                  <br />
                  Your current recovery codes will be <strong>invalidated</strong> and new ones will
                  be generated. You must save them.
                </AlertDescription>
              </Alert>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={handleClose}
                  disabled={pendingKeyFileLoading}
                >
                  Cancel
                </Button>
              </div>
            ...
            <div className="space-y-3">
              <Alert className="border-destructive/30 bg-destructive/10 border">
                ...
                <AlertDescription className="text-destructive text-xs">
                  ...
                  <br />
                  Your current recovery codes will be <strong>invalidated</strong> and new ones will
                  be generated. After removal your vault will be protected by your password only.
                </AlertDescription>
              </Alert>
              ...
              <div className="flex gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={handleClose} disabled={removeLoading}>
                  Cancel
                </Button>
              </div>
            </div>
